...
class AB_ScriptLoader {
  ...
  static function init() {
    ...
    //should eventually be replaced by CDN URL's
    ...
    //fastclick -> Note! As of 4/14, fastclick conflicts w/ Kindle Fire. Use w/ caution ~ LW
    'fastclick' => THEME_ROOT_URL."/vendor/fastclick.js",
